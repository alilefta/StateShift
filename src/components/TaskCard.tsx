...
import { removeTaskAtom } from "@/store/atoms";
	...
	return (
		...
		>
			...
			<div className="flex flex-col items-end h-full justify-between gap-2">
				...
				<Button className="hover:bg-red-50 transition-colors duration-200" size={"icon"} variant={"ghost"} onClick={() => removeTask({ taskId: task.id })}>
